...
<meta name="description" content="${luoyecong_seo_description}">
<meta name="author" content="CMS">
<link rel="icon" href="${TEMPLATE_BASE_PATH}/images/favicon.ico">

<title>${luoyecong_seo_title}</title>
...
<body>
	<div class="blog-masthead">
		<div class="container">
			<nav class="blog-nav">
			<@luoyecong_folder_list_tag folderId= 0>
			<a class="blog-nav-item <#if 0==g_folderId>active</#if>" href="${BASE_PATH}/index.htm">首页</a>
	                <#list tag_folder_list as tag_folder>
	                	<a class="blog-nav-item <#if tag_folder.folderId==g_folderId>active</#if>" href="<@luoyecong_folder_url_tag folderId=tag_folder.folderId/>">${tag_folder.name}</a>
			</#list>
           		</@luoyecong_folder_list_tag>
			</nav>
		</div>
	</div>
	<div class="container">
		<div class="blog-header">
			<h1 class="blog-title">${luoyecong_seo_title}</h1>
			<p class="lead blog-description">${luoyecong_seo_description}</p>
		</div>