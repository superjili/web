...
import com.luoyecong.cms.exception.TemplateNotFoundException;
...
public class TemplateService {
	...
	private String getTemplatePath(String template) {
		return "/template/"
				+ configService.getStringByKey(ConfigConstant.luoyecong_TEMPLATE)
				+ "/" + template;
	}
	...
	public Boolean isExist(String theme) {
		String themePath = "/WEB-INF/static/template/"
				+ configService.getStringByKey(ConfigConstant.luoyecong_TEMPLATE)
				+ "/" + theme + ".ftl";
		File file = new File(SystemConstant.luoyecong_CMS_ROOT + themePath);
		if (file.exists()) {
